...
const PostBar = () => {
  ...
  return (
    <div>
      ...
      <div className="lg:hidden flex justify-between items-center p-4 mx-3">
        <div className="font-bold text-xl lg:hidden">Posts(368)</div>
        <button className="flex items-center gap-2 lg:hidden bg-slate-300 text-black p-2 px-3 rounded">
          Filter: All <MdOutlineArrowDropDown />
        </button>
      </div>
    </div>
  );
